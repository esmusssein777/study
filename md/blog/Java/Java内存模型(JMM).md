...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vz7xymrvj30u00nf3yz.jpg)
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vz8izobpj30u00mc0t1.jpg)
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vz8th27vj30u0060jrj.jpg)
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vz954we8j30u00c3dg0.jpg)

假设处理器A和处理器B按程序的顺序并行执行内存访问，最终却可能得到 x = y = 0。具体的原因如下图所示：

![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vz9dcso7j30u00kn3yz.jpg)
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vz9o44y4j30u00ga3zj.jpg)
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vz9ts8y2j30u00muwfb.jpg)
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vzb4tzovj30fa0ao3yd.jpg)

如上图所示，A 和 C 之间存在数据依赖关系，同时 B 和 C 之间也存在数据依赖关系。因此在最终执行的指令序列中，C 不能被重排序到 A 和 B 的前面（C 排到 A 和 B 的前面，程序的结果将会被改变）。但 A 和 B 之间没有数据依赖关系，编译器和处理器可以重排序 A 和 B 之间的执行顺序。下图是该程序的两种执行顺序：

![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vzbc4ngoj30u00as74d.jpg)
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vzbij3tvj30tw0kijrd.jpg)

如上图所示，操作 1 和操作 2 做了重排序。程序执行时，线程 A 首先写标记变量 flag，随后线程 B 读这个变量。由于条件判断为真，线程 B 将读取变量 a。此时，变量 a 还根本没有被线程 A 写入，在这里多线程程序的语义被重排序破坏了！

2、当操作 3 和操作 4 重排序时会产生什么效果（借助这个重排序，可以顺便说明控制依赖性）。

![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vzbxgppgj30u00ksjrj.jpg)
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vzd0tj4lj30sk0mu3yo.jpg)
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vzd9n9jaj30u00ixq3s.jpg)

现在我们再假设这两个线程没有做同步，下面是这个未同步程序在顺序一致性模型中的执行示意图：

![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vzdlzwgtj30u00gzdgn.jpg)
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vzdu3d3qj30u00n0q3k.jpg)
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vze1b16wj30u00n4t8w.jpg)
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vze8tymsj30u00gj74c.jpg)
...
```
 ...
 2    volatile long a = 1L;         // 使用 volatile 声明 64 位的 long 型
 3
...
```
 ...
 3
 4    public synchronized void set(long l) {    //对单个普通变量的写用同一个锁同步
 5        a = l;                
 6    }
 7
 8    public synchronized long get() {        //对单个普通变量的读用同一个锁同步
 9        return a;           
10    }
11
12    public void getAndIncreament() {        //普通方法调用
13          long temp = get();                  //调用已同步的读方法
14        temp += 1L;                            //普通写操作                         
15          set(temp);                          //调用已同步的写方法
16    }
17}
```
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vzeield6j30u00npwes.jpg)

#### volatile 内存语义的实现

下面是 JMM 针对编译器制定的 volatile 重排序规则表：

![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vzeucdkcj30u009gaa6.jpg)
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vzf5a9f1j30u00hb74k.jpg)

下面是在保守策略下，volatile 读操作 插入内存屏障后生成的指令序列示意图：

![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vzffa7gyj30u00iot91.jpg)
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vzfs6nh0j30u00l8t8w.jpg)
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vzg6etvsj30u00ng3z1.jpg)

#### JMM 的设计示意图

![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vzglq9ffj30u00si3zc.jpg)
...
![](http://ww1.sinaimg.cn/large/007JYYsTgy1g2vzh2kcwzj30u00mxgm4.jpg)

原文地址：https://mp.weixin.qq.com/s/rkxcqZCvCnC0Psr0_oJzbQ